...
O perfil ativo `reference-canonical-v3` mantém o jogo em `0.0.3`: personagens são renderizados em 96×144 com pés em (48,136), mundo em 192×192, balcão de serviço em 256×192 e filtro nearest. Os quatro anexos canônicos são processados pelo Blender com chroma-key e seis frames por direção; fogão e geladeira expõem estados visuais completos.
