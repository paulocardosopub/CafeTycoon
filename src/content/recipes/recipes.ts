...
export const RECIPE_ROWS: readonly RecipeRow[] = [
  ...
  ['chocolate-cookies','Cookies de chocolate',2,'overnight',21600,160,'oven','Forneiro'],
  ['soup','Sopa de tomate',3,'medium',720,30,'cauldron','Chef de Sopas'],
  ['omelette','Omelete de queijo e ervas',4,'express',45,8,'stove','Cozinheiro Geral'],
  ['french-fries','Batata frita',5,'quick',240,20,'fryer','Fritureiro'],
  ['cheese-bread','Pão de queijo',6,'long',7200,80,'oven','Forneiro'],
  ['hot-dog','Cachorro-quente',7,'express',60,10,'grill','Chapeiro'],
  ['cheese-tapioca','Tapioca de queijo',8,'express',75,10,'grill','Chapeiro'],
  ['misto-quente','Misto-quente',9,'express',90,10,'grill','Chapeiro'],
  ['burger','Hambúrguer clássico',10,'quick',300,16,'grill','Chapeiro'],
  ['honey-pancakes','Panquecas com mel',11,'quick',360,18,'grill','Chapeiro'],
  ['coxinha','Coxinha',12,'medium',1500,40,'fryer','Fritureiro'],
  ['caesar-salad','Salada Caesar',13,'quick',240,16,'cold_prep','Cozinheiro Geral'],
  ['tomato-spaghetti','Espaguete ao molho de tomate',14,'medium',1200,36,'stove','Cozinheiro Geral'],
  ['cappuccino','Cappuccino',15,'express',45,12,'coffee_machine','Barista'],
  ['mozzarella-pizza','Pizza de muçarela',16,'medium',1500,40,'oven','Forneiro'],
  ['grilled-chicken-rice','Frango grelhado com arroz',17,'long',7200,60,'grill','Chapeiro'],
  ['caldo-verde','Caldo verde',18,'overnight',21600,140,'cauldron','Chef de Sopas'],
  ['donuts','Donuts',19,'long',10800,72,'fryer','Fritureiro'],
  ['cheeseburger','Cheeseburger',20,'quick',420,18,'grill','Chapeiro'],
  ['croissant','Croissant',22,'long',14400,80,'oven','Forneiro'],
  ['meat-pastel','Pastel de carne',24,'quick',480,24,'fryer','Fritureiro'],
  ['bolognese-lasagna','Lasanha à bolonhesa',26,'long',10800,64,'oven','Forneiro'],
  ['mushroom-risotto','Risoto de cogumelos',28,'medium',2100,32,'stove','Cozinheiro Geral'],
  ['fish-moqueca','Moqueca de peixe',30,'long',9000,56,'stove','Cozinheiro Geral'],
  ['hot-chocolate','Chocolate quente',32,'express',60,12,'coffee_machine','Barista'],
  ['fish-and-chips','Fish and chips',34,'quick',600,22,'fryer','Fritureiro'],
