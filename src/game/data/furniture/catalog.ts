...
export const FURNITURE_DEFINITIONS: readonly FurnitureDefinition[] = [
  definition({ id: 'cooking.a1.stove', code: 'A1', category: 'cooking', name: 'Fogão industrial com fornos', assetId: 'a1_stove_industrial', price: 260, functionId: 'stove', workSlots: [work('work', { x: 0, y: 1 }, 'any', 'work')], essential: true }),
