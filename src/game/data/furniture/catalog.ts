...
export const FURNITURE_DEFINITIONS: readonly FurnitureDefinition[] = [
  ...
  definition({ id: 'cooking.a2.convection', code: 'A2', category: 'cooking', name: 'Forno de convecção', assetId: 'a2_convection_oven', price: 220, functionId: 'oven', visualScale: .51 }),
  definition({ id: 'cooking.a3.griddle', code: 'A3', category: 'cooking', name: 'Chapa industrial', assetId: 'a3_griddle', price: 190, functionId: 'grill', visualScale: .6 }),
  definition({ id: 'cooking.a4.fryer', code: 'A4', category: 'cooking', name: 'Fritadeira industrial', assetId: 'a4_fryer', price: 210, functionId: 'grill', visualScale: .6 }),
  definition({ id: 'cooking.a5.kettle', code: 'A5', category: 'cooking', name: 'Caldeira industrial', assetId: 'a5_kettle', price: 225, functionId: 'cauldron', visualScale: .68 }),
  ...
  definition({ id: 'washing.b5.sink', code: 'B5', category: 'washing', name: 'Pia industrial', width: 2, assetId: 'b5_industrial_sink', price: 130, functionId: 'sink', workSlots: doubleWork(), essential: true, visualScale: .9 }),
  ...
  definition({ id: 'service.c8.waste', code: 'C8', category: 'service', name: 'Lixeira e reciclagem', assetId: 'c8_waste_recycling', price: 80, functionId: 'decoration', source: FURNITURE_SOURCE, visualScale: .63 }),
  ...
  definition({ id: 'dining.table.basic', code: 'T1', category: 'tables', name: 'Mesa básica', assetId: 'table_two', price: 70, functionId: 'table', skinIds: ['table-oak', 'table-green'], source: FURNITURE_SOURCE, workSlots: [], visualScale: .82 }),
  definition({ id: 'dining.chair.basic', code: 'CH1', category: 'chairs', name: 'Cadeira básica', assetId: 'chair_wood', price: 35, functionId: 'chair', skinIds: ['chair-wood', 'chair-upholstered', 'chair-bistro'], source: FURNITURE_SOURCE, workSlots: [], visualScale: .93 }),
