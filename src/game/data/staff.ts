...
export const STAFF_CATALOG: readonly StaffDefinition[] = [
  ...
  staff({ id: 'stocker-0', actorId: 'employee-stocker-001', role: 'stocker', name: 'Davi', assetId: 'stocker-0', includedByDefault: false, hiringCost: 0, salary: 18, suggestedStart: { x: 3, y: 4 }, facing: 'ne', carryingCapacity: 16, traits: ['Carga segura'] }),
  staff({ id: 'cook-1', actorId: 'employee-cook-002', role: 'cook', name: 'Lúcia', assetId: 'cook-1', includedByDefault: false, hiringCost: 120, salary: 27, suggestedStart: { x: 6, y: 4 }, facing: 'ne', taskSpeed: 1.12, quality: 1.14, traits: ['Forno preciso'], specialties: ['Forneiro'], primaryProfession: 'Forneiro', minimumLevel: 2, compatibleStationId: 'oven' }),
  staff({ id: 'cook-2', actorId: 'employee-cook-003', role: 'cook', name: 'João', assetId: 'cook-2', includedByDefault: false, hiringCost: 160, salary: 29, suggestedStart: { x: 6, y: 5 }, facing: 'ne', traits: ['Chapa rápida'], specialties: ['Chapeiro'], primaryProfession: 'Chapeiro', minimumLevel: 7, compatibleStationId: 'grill' }),
  staff({ id: 'cook-3', actorId: 'employee-cook-004', role: 'cook', name: 'Célia', assetId: 'cook-3', includedByDefault: false, hiringCost: 130, salary: 31, suggestedStart: { x: 5, y: 5 }, facing: 'ne', traits: ['Caldos precisos'], specialties: ['Chef de Sopas'], primaryProfession: 'Chef de Sopas', minimumLevel: 3, compatibleStationId: 'cauldron' }),
  ...
  staff({ id: 'cook-6', actorId: 'employee-cook-007', role: 'cook', name: 'Rosa', assetId: 'cook-6', includedByDefault: false, hiringCost: 140, salary: 25, suggestedStart: { x: 4, y: 5 }, facing: 'ne', traits: ['Versátil'], specialties: ['Cozinheiro Geral'], primaryProfession: 'Cozinheiro Geral', minimumLevel: 4, compatibleStationId: 'stove' }),
  staff({ id: 'cook-7', actorId: 'employee-cook-008', role: 'cook', name: 'Bia', assetId: 'cook-7', includedByDefault: false, hiringCost: 150, salary: 26, suggestedStart: { x: 4, y: 6 }, facing: 'ne', traits: ['Fritura crocante'], specialties: ['Fritureiro'], primaryProfession: 'Fritureiro', minimumLevel: 5, compatibleStationId: 'grill' }),
