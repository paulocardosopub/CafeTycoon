# Perfil de referência `reference-hd-v2`
...
O pipeline reproduz essas características por geometria, materiais, câmera, iluminação e render automatizado do Blender. Todos os arquivos finais têm fundo transparente, pixels nítidos, escala nativa e manifest individual.
