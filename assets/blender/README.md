...
- `characters/characters_base.blend`: 4 estilos do jogador, 8 clientes e 6 funcionários; cada collection possui rig `bistro_humanoid_v1`, biblioteca compartilhada e marcadores.
...
Materiais, rig, câmera e luz são compartilhados dentro dos arquivos de família para evitar duplicação. Cada asset permanece separado por collection/ID. Níveis 2 a 4 não possuem modelos ou placeholders nesta versão.
